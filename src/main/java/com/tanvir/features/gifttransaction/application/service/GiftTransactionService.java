                ...
                .map(level -> {
                    ...
                    return Announcement
                            ...
                            .receiverUser(AnnouncementUser
                                    ...
                                    .maxId(giftTransaction.getSenderReceiverDto().getReceiver().getMaxId())
                                    .levelUrl(receiverLevelResource.getResourceUrl())
                                    .profileFrameId(giftTransaction.getSenderReceiverDto().getReceiver().getProfileFrameId())
                                    .profileFrameUrl(giftTransaction.getSenderReceiverDto().getReceiver().getProfileFrameUrl())
                                    .profileImageId(giftTransaction.getSenderReceiverDto().getReceiver().getProfileImageId())
                                    .profileImageUrl(giftTransaction.getSenderReceiverDto().getReceiver().getProfileImageUrl())
                                    .build())
                            .gift(Announcement.Gift
                                    .builder()
                                    .quantity(giftTransaction.getQuantity())
