...
```
cd existing_repo
git remote add origin https://gitlab.com/max-live/max-live-spring-home.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/max-live/max-live-spring-home/-/settings/integrations)
